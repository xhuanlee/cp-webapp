...
class NormalLoginForm extends React.Component {
  ...
  render() {
    ...
    username = username || '';
    const inputStyle = { fontSize: 16, height: 40 };
    return (
      <Row
        type="flex"
        align="middle"
          ...
          <Form onSubmit={this.handleSubmit} className="login-form">
            ...
            <FormItem>
              {getFieldDecorator('userName', {
                ...
                <Input size="large" style={inputStyle} prefix={<Icon type="user" style={{ fontSize: 16 }} />} placeholder="用户名" />
              )}
            </FormItem>
            <FormItem>
              {getFieldDecorator('password', {
                ...
                <Input size="large" style={inputStyle} prefix={<Icon type="lock" style={{ fontSize: 16 }} />} type="password" placeholder="密码" />
              )}
            </FormItem>
            <FormItem>
